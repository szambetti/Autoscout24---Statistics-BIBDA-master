...
%let EM_NUM_VARS = 40;
   ...
   Tipo_di_vernice Usato_Garantito VAR36 Veicolo_per_non_fumatori address
...
%let EM_NUM_INTERVAL = 23;
   %macro EM_INTERVAL;
    Anno Cilindrata Cilindri Consumo_Carburante_Totale Emissioni_di_CO2 Marce
   Per_neopatentati Peso_a_vuoto Porte Posti_a_sedere Tagliandi_certificati
   Usato_Garantito VAR36 Veicolo_per_non_fumatori conditional_on_price discount
   median price target10 target20 target_35 target_5 variazione_su_mediana
   %mend EM_INTERVAL;
...
%let EM_NUM_INTERVAL_INPUT = 19;
   ...
   Per_neopatentati Peso_a_vuoto Porte Posti_a_sedere Tagliandi_certificati
   Usato_Garantito VAR36 Veicolo_per_non_fumatori conditional_on_price discount
   median price variazione_su_mediana
